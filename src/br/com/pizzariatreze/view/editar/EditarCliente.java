...
import br.com.pizzariatreze.view.consulta.ConsultaCliente;
...
public class EditarCliente extends javax.swing.JFrame {
    ...
    public EditarCliente(int id) throws ParseException {
        initComponents();
        ClienteDao cdao = new ClienteDao();
        this.cliente = cdao.getById(id);
        ...
        String cpfCliente = mf.valueToString(this.cliente.getCpf());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        cliente.put("id", String.valueOf(this.cliente.getId()));
        ...
        String resposta = "";
        try {
            resposta = clienteCtrl.save(cliente) ? "Cliente alterado com sucesso." : "Erro ao alterar cliente.";
        } catch (Exception e) {
