...
import br.com.pizzariatreze.view.consulta.ConsultaFuncionario;
...
public class EditarFuncionario extends javax.swing.JFrame {
    ...
    public EditarFuncionario(int id) throws ParseException {
        initComponents();
        FuncionarioDao fdao = new FuncionarioDao();
        this.func = fdao.getById(id);
        txtNome.setText(this.func.getNome());
        txtCargo.setText(this.func.getCargo());
        txtSalario.setText(String.valueOf(this.func.getSalario()));
        MaskFormatter mf = new MaskFormatter("###.###.###-##");
        mf.setValueContainsLiteralCharacters(false);
        String cpfFuncionario = mf.valueToString(this.func.getCpf());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        funcionario.put("id", String.valueOf(this.func.getId()));
        ...
        String resposta = "";
        try {
            resposta = funcionarioCtrl.save(funcionario) ? "Funcionario editado com sucesso." : "Erro ao editar funcionario.";
        } catch (Exception e) {
            e.printStackTrace();
