...
public class DetalhesPedidoTableModel extends AbstractTableModel {
    ...
    public DetalhesPedidoTableModel() {
        /* Definição das colunas da tabela */
        colunas = new Vector();
        colunas.add("ID");
        colunas.add("Telefone Cliente");
    ...
    public void adicionar(List<Object> lista) {
        ...
        for (Object p : lista) {
            ...
            linha.add(pedido.getId());
            linha.add(pedido.getCliente().getTelefone());
            linha.add(pedido.getCliente().getNome());
            linha.add(pedido.getPreco());
